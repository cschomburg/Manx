...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Thu Jun 10 22:28:37 2010
# Project:  Manx.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		qnbttag.cpp \
		nbtreader.cpp moc_mainwindow.cpp \
		moc_qnbttag.cpp
OBJECTS       = main.o \
		mainwindow.o \
		nbttag.o \
