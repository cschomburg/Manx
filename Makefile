...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Jun 8 13:54:29 2010
# Project:  Manx.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		qnbttag.cpp moc_mainwindow.cpp \
		moc_qnbttag.cpp
OBJECTS       = main.o \
		mainwindow.o \
		nbttag.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Manx1.0.0/ && $(COPY_FILE) --parents mainwindow.h nbttag/nbttag.h nbttag/nbttagbyte.h nbttag/nbttagshort.h nbttag/nbttagint.h nbttag/nbttaglong.h nbttag/nbttagfloat.h nbttag/nbttagdouble.h nbttag/nbttagbytearray.h nbttag/nbttagstring.h nbttag/nbttaglist.h nbttag/nbttagcompound.h nbttag/nbttags.h qnbttag.h .tmp/Manx1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp nbttag/nbttag.cpp nbttag/nbttagbyte.cpp nbttag/nbttagshort.cpp nbttag/nbttagint.cpp nbttag/nbttaglong.cpp nbttag/nbttagfloat.cpp nbttag/nbttagdouble.cpp nbttag/nbttagbytearray.cpp nbttag/nbttagstring.cpp nbttag/nbttaglist.cpp nbttag/nbttagcompound.cpp qnbttag.cpp .tmp/Manx1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Manx1.0.0/ && (cd `dirname .tmp/Manx1.0.0` && $(TAR) Manx1.0.0.tar Manx1.0.0 && $(COMPRESS) Manx1.0.0.tar) && $(MOVE) `dirname .tmp/Manx1.0.0`/Manx1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Manx1.0.0
